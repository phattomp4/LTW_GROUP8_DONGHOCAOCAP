...
<head>
    ...
    <link rel="stylesheet" href="../css/FavoritesList.css">
...
<body>
    ...
    <div class="contents">
        ...
        <div class="title-favorites-list">
            <h2>Danh sách đã lưu (5)</h2>
        </div>
        ...
        <div class="Product-list-container">
            <div class="Product-page">
                <div href="" class="link-product">
                    <div class="Product">
                        <a href="TrangChiTietSanPham.html" class><img src="https://www.watchstore.vn/wp-content/uploads/2023/11/8907g-vt-d-1-1173700471-248243325-1712668536-400x400.jpg" alt=""></a>
                        <br />
    ...
    <script src="../Share/css/ProductCards.js"></script>
