...
<head>
    ...
    <style>
        ...
        .sidebar h2 { text-align: center; margin-bottom: 20px; color: #d0011b; font-size: 22px; border-bottom: 1px solid #4b545c; padding-bottom: 15px; }
        .sidebar a { display: block; padding: 15px 20px; color: #c2c7d0; text-decoration: none; border-bottom: 1px solid #4b545c; transition: 0.3s; }
        .sidebar a:hover, .sidebar a.active { background: #d0011b; color: white; padding-left: 25px; }
...
<div class="content">
    <div class="page-header">
        <h2 style="border-left: 5px solid #d0011b; padding-left: 15px; color: #333;">Danh sách sản phẩm</h2>
