...
<script>
    function editCategory(id, name, parentId) {
        ...
        // 2. Đổi hành động thành UPDATE
        document.getElementById('catAction').value = 'update';

        // 3. Đổi giao diện nút bấm
    ...
    function editPrice(id, label, min, max) {
        ...
        // Chuyển về dạng số nguyên (bỏ .0 nếu có) để hiển thị đẹp hơn trong input number
    ...
    function cancelEditPrice() {
        ...
        btn.style.background = '#d0011b'; // Về màu đỏ gốc
